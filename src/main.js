...
import { faListUl, faAngleLeft, faCog, faChartBar, faEllipsisV, faPlay, faPlus, faStop, faSyncAlt, faTrash, faCheck, faPowerOff, faUserCircle } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome'

import VueGAPI from 'vue-gapi'
import ga from 'vue-ga'

library.add(faListUl, faAngleLeft, faCog, faChartBar, faEllipsisV, faPlay, faPlus, faStop, faSyncAlt, faTrash, faCheck, faPowerOff, faUserCircle)
